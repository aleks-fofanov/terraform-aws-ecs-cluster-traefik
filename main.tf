...
module "autoscaling_group" {
  ...
  iam_instance_profile_name            = aws_iam_instance_profile.ecs_instance[0].name
  service_linked_role_arn              = var.ec2_asg_service_linked_role_arn
  associate_public_ip_address          = local.ec2_nat_setup ? false : true
